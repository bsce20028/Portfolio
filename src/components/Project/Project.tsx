          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/bsce20028/audio-rag-backend"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>AudioRAG ( AI-Powered Audio Transcription & Q&A )</h3>
              <p>
                I have successfully built AudioRAG, production-ready audio
                intelligence platform that transcribes audio, identifies
                speakers, and enables AI-powered Q&A with timestamps and speaker
                attribution. The complete system includes: FastAPI backend with
                faster-whisper transcription and pyannote.audio speaker
                detection PostgreSQL + pgvector semantic search with RAG chat
                Next.js 14 frontend with real-time streaming Celery + Redis
                async processing
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/bsce20028/E-commerce-Shoes-website-with-Virtually-Try-on-Feature"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="GitHub" />
            ...
            <div className="body">
              <h3>E-commerce Shoes website with Virtually Try-on Feature</h3>
              <p>
                Online shopping offers convenience, it often lacks the tactile
                experience that traditional in-store shopping provides. To
                address these challenges, our platform will introduce a
                groundbreaking feature. The ”Virtual Try Room”, will enable
                users to virtually try on shoes using augmented reality (AR)
                technology.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/bsce20028/Nest-Concepts"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Github" />
            ...
            <div className="body">
              ...
              <p>
                Implemented a robust Incident Management system using Nest JS
                and detailed audit tracking. Developed a Reporting module
                supporting single reports per incident with file upload and
                secure file replacement. Built an Activity Log that records all
                changes with old and new values using a reusable comparison
                helper. Added Watcher-based email notifications for incident and
                report lifecycle events. Integrated Winston logging for
                centralized request and performance monitoring.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
